  ...
  return (
    <div className="container-page py-12 pt-48">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold text-blue-700 mb-8">Cookie Policy</h1>
        ...
        <Card className="mt-8">
          ...
          <CardContent>
            <h3 className="text-xl font-semibold mb-3">Account Related Cookies</h3>
            <p className="text-slate-700 mb-4">
            ...
            <h3 className="text-xl font-semibold mb-3 mt-6">Login Related Cookies</h3>
            <p className="text-slate-700 mb-4">
            ...
            <h3 className="text-xl font-semibold mb-3 mt-6">Site Preferences Cookies</h3>
            <p className="text-slate-700 mb-4">
              In order to provide you with a great experience on this site, we provide 
              the functionality to set your preferences for how this site runs when you use it. 
        ...
        <Card className="mt-8">
          ...
          <CardContent>
            ...
            <h3 className="text-xl font-semibold mb-3 mt-6">Social Media Platforms</h3>
            <p className="text-slate-700">
              Third party social media platforms may set cookies through our site which may be 
        ...
        <Card className="mt-8">
          ...
          <CardContent>
            ...
            <ul className="list-disc pl-6 space-y-2 text-slate-700 mt-4">
              <li>Email: privacy@riverwatts.com</li>
              <li>By visiting this link: <a href="/contact" className="text-blue-600 hover:underline">Contact Us</a></li>
            </ul>
